...
INPUT_DIR = Path(
    "../results/hit_ltb_training19_500_reduced"
)

OUTPUT_DIR = Path(
    "../results/ranking_dataset_xgb19_reduced_continuous"
)


def convert_scores_to_continuous(scores):
...
def main():
    ...
    for file in files:
        ...
        with open(
            ...
            while True:
                ...
                labels = convert_scores_to_continuous(
                    scores
                )
    ...
    print(
        "XGBOOST RANKING DATASET - CONTINUOUS SB"
    )
