...
from solver_scip_default_dimacs import solve_scip_default
from solver_xgb import solve_xgb_dimacs, solve_xgb_snap
...
OUTPUT_DIR = (
    Path("results")
    / "anytime_comparison"
    / f"depth_SCIP_FRB30_1_DEFAULT{XGB_DEPTH}"
)
