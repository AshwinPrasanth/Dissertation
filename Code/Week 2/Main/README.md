...
- Strategy comparison image: [Code/Week 2/Main/Results/strategy_comparison.png](Code/Week 2/Main/Results/strategy_comparison.png)
- Strategy comparison CSV: [Code/Week 2/Main/Results/strategy_comparison.csv](Code/Week 2/Main/Results/strategy_comparison.csv)
- Certainty evolution: [Code/Week 2/Main/Results/certainty_evolution.png](Code/Week 2/Main/Results/certainty_evolution.png)
- Scaling benchmark: [Code/Week 2/Main/Results/scaling_benchmark.png](Code/Week 2/Main/Results/scaling_benchmark.png)
- Scaling CSV: [Code/Week 2/Main/Results/scaling_benchmark.csv](Code/Week 2/Main/Results/scaling_benchmark.csv)
- Density sweep: [Code/Week 2/Main/Results/density_sweep.png](Code/Week 2/Main/Results/density_sweep.png)
- Density sweep CSV: [Code/Week 2/Main/Results/density_sweep.csv](Code/Week 2/Main/Results/density_sweep.csv)
- Backbone analysis: [Code/Week 2/Main/Results/backbone_analysis.png](Code/Week 2/Main/Results/backbone_analysis.png)
- Backbone CSV: [Code/Week 2/Main/Results/backbone_analysis.csv](Code/Week 2/Main/Results/backbone_analysis.csv)
- MWUA ablation: [Code/Week 2/Main/Results/mwua_ablation.png](Code/Week 2/Main/Results/mwua_ablation.png)
- MWUA ablation CSV: [Code/Week 2/Main/Results/mwua_ablation.csv](Code/Week 2/Main/Results/mwua_ablation.csv)
- Reductions impact: [Code/Week 2/Main/Results/reductions_impact.png](Code/Week 2/Main/Results/reductions_impact.png)
- Reductions impact CSV: [Code/Week 2/Main/Results/reductions_impact.csv](Code/Week 2/Main/Results/reductions_impact.csv)
- Depth pruning heatmap: [Code/Week 2/Main/Results/depth_pruning_heatmap.png](Code/Week 2/Main/Results/depth_pruning_heatmap.png)

## Inline figures

<p align="center">
  <img src="Code/Week 2/Main/Results/strategy_comparison.png" alt="strategy comparison" width="600"/>
</p>

<p align="center">
  <img src="Code/Week 2/Main/Results/certainty_evolution.png" alt="certainty evolution" width="600"/>
</p>

<p align="center">
  <img src="Code/Week 2/Main/Results/depth_pruning_heatmap.png" alt="depth pruning heatmap" width="600"/>
</p>
