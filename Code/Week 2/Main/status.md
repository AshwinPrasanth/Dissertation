...
- Image: [results_focus/strategy_comparison.png](Lit/week-1/results_focus/strategy_comparison.png)
- CSV: [results_focus/strategy_comparison.csv](Lit/week-1/results_focus/strategy_comparison.csv)

### Full results folder

- Strategy comparison image: [Results/strategy_comparison.png](Results/strategy_comparison.png)
- Strategy comparison CSV: [Results/strategy_comparison.csv](Results/strategy_comparison.csv)
- Certainty evolution: [Results/certainty_evolution.png](Results/certainty_evolution.png)
- Scaling benchmark: [Results/scaling_benchmark.png](Results/scaling_benchmark.png)
- Scaling CSV: [Results/scaling_benchmark.csv](Results/scaling_benchmark.csv)
- Density sweep: [Results/density_sweep.png](Results/density_sweep.png)
- Density sweep CSV: [Results/density_sweep.csv](Results/density_sweep.csv)
- Backbone analysis: [Results/backbone_analysis.png](Results/backbone_analysis.png)
- Backbone CSV: [Results/backbone_analysis.csv](Results/backbone_analysis.csv)
- MWUA ablation: [Results/mwua_ablation.png](Results/mwua_ablation.png)
- MWUA ablation CSV: [Results/mwua_ablation.csv](Results/mwua_ablation.csv)
- Reductions impact: [Results/reductions_impact.png](Results/reductions_impact.png)
- Reductions impact CSV: [Results/reductions_impact.csv](Results/reductions_impact.csv)
- Depth pruning heatmap: [Results/depth_pruning_heatmap.png](Results/depth_pruning_heatmap.png)

## Inline figures

<p align="center">
  <img src="Results/strategy_comparison.png" alt="strategy comparison" width="600"/>
</p>

<p align="center">
  <img src="Results/certainty_evolution.png" alt="certainty evolution" width="600"/>
</p>

<p align="center">
  <img src="Results/depth_pruning_heatmap.png" alt="depth pruning heatmap" width="600"/>
</p>
